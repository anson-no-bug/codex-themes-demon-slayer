...
把 Codex 会话变成鬼杀队任务案卷：角色编队、任务地点、对手难度和呼吸法反馈会随当前会话稳定组合。适用于 Codex Desktop + [BigPizzaV3 Codex++](https://github.com/BigPizzaV3/CodexPlusPlus) `>= 1.2.41`，当前版本 `0.5.22`。
...
- 右侧任务案卷、渡鸦情报与出战小队按 Codex 内部模块键识别；宿主界面显示英文、中文或其它文案都不会改变主题模块名。
